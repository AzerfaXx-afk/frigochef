...
import { User, Moon, Sun, Camera, ToggleLeft, ToggleRight, Smartphone, Share, X, MoreVertical, Download, HelpCircle, Flame, Bell, CheckCircle, Trash2, Check } from 'lucide-react';
...
const Profile: React.FC<Props> = ({ 
    ...
    notificationsEnabled, toggleNotifications, notifications, markAsRead, deleteNotification, clearAllNotifications, triggerTestNotification 
}) => {
                        ...
                        <div className="max-h-60 overflow-y-auto">
                            {notifications.map(notif => (
                                <div 
                                    ...
                                    className={`p-4 border-b border-slate-100 dark:border-slate-700/50 cursor-pointer transition-all flex gap-3 ${
                                        notif.read ? 'opacity-60 bg-transparent' : 'bg-white dark:bg-slate-800 border-l-4 border-l-emerald-500'
                                    }`}
                                >
