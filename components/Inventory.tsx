            ...
            <div className="p-3 sm:p-4 bg-white dark:bg-slate-800 border-b border-slate-100 dark:border-slate-700 flex-shrink-0 z-10 transition-colors duration-300">
                <div className="flex gap-1.5 sm:gap-2 mb-3">
                    ...
                    <button
                        ...
                        disabled={!newItem.trim() || isScanning}
                        className="bg-emerald-600/90 text-white w-12 h-12 rounded-xl flex items-center justify-center hover:bg-emerald-600 active:scale-95 transition-all shadow-sm disabled:opacity-50 shrink-0"
                    >
                        <Plus size={22} />
                    </button>
